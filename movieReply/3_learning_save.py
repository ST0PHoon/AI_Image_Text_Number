...
train_data = data_load('ratings_train_minimum.txt')
test_data = data_load('ratings_test_minimum.txt')
...
selected_words = [f[0] for f in text.vocab().most_common(20001)]
...
model.add(layers.Dense(64, activation='relu', input_shape=(19101,)))
